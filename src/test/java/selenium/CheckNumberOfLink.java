...
public class CheckNumberOfLink {
    public static void main(String[] args) {
//
        //TC	#1:	Checking	the	number	of	links	on	the	page
        //1.Open	Chrome	browser
        //2.Go	to	https://www.openxcell.com
        // 3.Count	the	number	of	the	links	on	the	page	and	verify  Expected:	188
        ...
        if(expectedNum == actualNum){
            System.out.println("List size is Passed");
        }else {
            System.out.println("List size is Failed");
        }

       //Print	out	all	of	the	texts	of	the	links
        //printing out the text of each webElement
